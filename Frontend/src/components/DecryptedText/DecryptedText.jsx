...
export default function DecryptedText({
  ...
  return (
    <motion.span className={`${parentClassName} decrypted-text-wrapper`} ref={containerRef} {...animateProps} {...props}>
      <span className="decrypted-text-sr-only">{displayText}</span>
